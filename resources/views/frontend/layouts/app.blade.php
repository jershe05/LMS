...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ __('Learning Management System') }}</title>
    ...
    <!-- CSS Files -->
    <link href="{{ asset('frontend/backend.css"') }}" rel="stylesheet" />
    ...
    <body class="{{ $class ?? '' }}">
        ...
        @auth()
            ...
            @include('frontend.layouts.page_templates.auth')
        @endauth

        @guest()
            @include('frontend.layouts.page_templates.guest')
        @endguest
        ...
        <!-- Chartist JS -->
        <script src="{{ asset('js/plugins/chartist.min.j') }}s"></script>
